...
const Sidebar = () => {
  ...
  const { setDisplayResult, setInput, prevPrompts, setRecentPrompts, submit,result,setResult } = useContext(Context);
  ...
  return (
    <div className="min-h-[100vh] inline-flex flex-col justify-between bg-bgSecondaryColor py-6 px-4">
      <div>
        ...
        />
        <div
          className="mt-2.5 inline-flex py-2.5 items-center gap-2.5 px-4 bg-[#022B42] rounded-xl text-md text-gray-400 cursor-pointer"
          onClick={() => {
          ...
          <div className="flex flex-col">
            ...
            {prevPrompts?.map((item, index) => (
              <div
                ...
                className="my-2 flex items-center gap-2.5 pr-10 rounded-lg text-gray-700 cursor-pointer hover:bg-slate-200 p-2 bg-bgPrimaryColor"
              >
                <MessageSquare
                  size={20}
                  className="cursor-pointer text-softTextColor"
